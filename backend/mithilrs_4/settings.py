"""
Django settings for mithilrs_4 project.
...
WSGI_APPLICATION = 'mithilrs_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithilrs_4 API",
    "DESCRIPTION": "API documentation for mithilrs_4 App",
    "VERSION": "v1",
}
